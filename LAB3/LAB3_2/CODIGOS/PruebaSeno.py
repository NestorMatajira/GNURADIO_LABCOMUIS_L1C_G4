...
class PruebaSeno(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PruebaSeno", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PruebaSeno")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PruebaSeno")
...
def main(top_block_cls=PruebaSeno, options=None):
