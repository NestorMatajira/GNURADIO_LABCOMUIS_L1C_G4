...
from EnvolventecomplejaPML1C import EnvolventecomplejaPML1C  # grc-generated hier_block
...
class Modulacion_PM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._kp_win = RangeWidget(self._kp_range, self.set_kp, 'coefieciene kp', "counter_slider", float)
        self.top_layout.addWidget(self._kp_win)
        self._gtx_range = Range(0, 30, 1, 1, 200)
        self._gtx_win = RangeWidget(self._gtx_range, self.set_gtx, 'ganacia tranmisor', "counter_slider", float)
        ...
        self.EnvolventecomplejaPML1C_0 = EnvolventecomplejaPML1C(
            Ac=ac,
            Kp=kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventecomplejaPML1C_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.EnvolventecomplejaPML1C_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.EnvolventecomplejaPML1C_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.EnvolventecomplejaPML1C_0, 0))
    ...
    def set_kp(self, kp):
        self.kp = kp
        self.EnvolventecomplejaPML1C_0.set_Kp(self.kp)
    ...
    def set_ac(self, ac):
        self.ac = ac
        self.EnvolventecomplejaPML1C_0.set_Ac(self.ac)
