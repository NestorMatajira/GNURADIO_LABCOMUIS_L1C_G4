...
class PruebaModuladorsDSB_SC(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PruebaModuladorsDSB_SC")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PruebaModuladorsDSB_SC")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PruebaModuladorsDSB_SC")
        ...
        self._mode_win = RangeWidget(self._mode_range, self.set_mode, 'Modo', "counter_slider", float)
    ...
    def set_mode(self, mode):
        self.mode = mode
        self.Envolvente_compleja_DSB_SC_0.set_K(self.mode)
...
def main(top_block_cls=PruebaModuladorsDSB_SC, options=None):
